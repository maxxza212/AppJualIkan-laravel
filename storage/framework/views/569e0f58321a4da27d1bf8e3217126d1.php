<nav class="mb-3 d-flex justify-content-lg-between navbar3">
    <div class="d-flex flex-column">
        <ol class="breadcrumb mb-0">
            <li class="breadcrumb-item active"><a href="#"><?php echo e($name ?? 'Admin'); ?></a></li>
        </ol>
    </div>
...
</nav><?php /**PATH C:\xampp\htdocs\AppTokoIkan\resources\views/admin/components/navbar.blade.php ENDPATH**/ ?>